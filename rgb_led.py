...
class rgb_led(object):
    ...
    def __init__(self, red_gpio_pin, green_gpio_pin, blue_gpio_pin, red_level=100, green_level=100, blue_level=100):
...
if __name__ == '__main__':  #test code
    left_eye = rgb_led(13, 17, 6)
    right_eye = rgb_led(12, 16, 5)
    time.sleep(0.5)
